#!/bin/bash
set -o errexit
# 2009-11-23 TDW <troydwill@gmail.com>
PACKAGE='qt'
VERSION='4.6.0'
PACKAGER='TDW'
DATE='2009-11-23'
...
STOW_DIR='/stow'
INSTALL_ROOT="${STOW_DIR}/${PACKAGE}-${VERSION}"
SUDO='sudo'
...
exit
Notes:
TDW/2009-10-26: Discovered that Qt uses a INSTALL_ROOT equivalent to DESTDIR
...
Installation options:
 ...
 These are optional, but you may specify install directories.
    ...
    -prefix <dir> ...... This will install everything relative to <dir>
                         (default /usr/local/Trolltech/Qt-4.6.0)

  * -prefix-install .... Force a sandboxed "local" installation of
                         Qt. This will install into
                         /usr/local/Trolltech/Qt-4.6.0, if this option is
