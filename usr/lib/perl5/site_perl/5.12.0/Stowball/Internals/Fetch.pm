package Stowball::Internals::Fetch;

use strict;

# use Stowball::Error;
use Stowball::Internals::Constants;
...
use Locale::Maketext::Simple    Class => 'Stowball', Style => 'gettext';

$Params::Check::VERBOSE = 1;

my $ff = File::Fetch->new(uri=> 'http://cpan.perl.org/authors/id/M/MA/MAKAMAKA/Text-CSV-1.17.tar.gz');
my $where = $ff->fetch() or die $ff->error;
$ff = File::Fetch->new(uri=> 'rsync://i/sources/qt-everywhere-opensource-src-4.7.0-tp.tar.gz');
chdir "/tmp";
...
Stowball::Internals::Fetch fetches files from either ftp, http, file
or rsync mirrors.
...
object for a one-off fetch, look at C<Stowball::Module::Fake>.
...
Mark a particular host as bad. This makes C<Stowball::Internals::Fetch>
